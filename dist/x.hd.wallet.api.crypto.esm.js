...
function deriveChildNodePublic(extendedKey, index, g = 9) {
    ...
    data[0] = 0x03;
    const fullChildChainCode = createHmac("sha512", cc)
        .update(data)
        .digest();
...
export { BIP32DerivationType, ERROR_BAD_DATA, ERROR_TAGS_FOUND, Encoding, KeyContext, XHDWalletAPI, deriveChildNodePublic, fromSeed, harden };
